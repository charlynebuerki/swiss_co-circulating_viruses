...
```{r}
# Parainfluenza-4
virus_strain <- "Human parainfluenza virus 4"
hpiv_4_data <- hq_data %>% filter(grepl(virus_strain, substrain_name, fixed=TRUE))

df <- format_coverage_plot_data(hpiv_4_data, virus_strain)
make_figure_coverage_genome(df, virus_strain, save=FALSE)
