...
rule filter:
    ...
    output:
        ...
        log = "log/{subtype}/{build}/filtered.log",
    params:
        ...
        include = "data/project_strains/1_names_Human_metapneumovirus.txt",
    shell:
        """
        augur filter \
            ...
            --query 'subtypes == {params.subtype} & {params.build}_coverage > {params.min_coverage} & institution != "ETH Zurich, Computational Evolution group, Mattenstrasse 26" | database=="ReVSeq" '\
...
rule filter2:
    ...
    output:
        ...
        log = "log/{subtype}/{build}/filtered2.log",
    params:
